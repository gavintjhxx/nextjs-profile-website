export default function SocialsWidget(item) {
    return (
        <>
            <div className="max-w-2xl px-10 py-6 my-4 mx-auto bg-blogWidget rounded-lg shadow-lg" key={item.key}>
                <img src={item.imagePath} className="w-14 h-14 mr-5 align-middle inline-block" />
